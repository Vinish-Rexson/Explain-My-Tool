...
const AuthButton = () => {
  ...
  return (
    <>
      ...
      {/* Auth Modal - Fixed with higher z-index and proper positioning */}
      {showAuthModal && (
          ...
          <div className="min-h-screen px-4 py-8 flex items-center justify-center">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative transform transition-all">
              ...
              <button
                ...
                className="w-full bg-white border-2 border-gray-300 text-gray-700 py-4 px-4 rounded-lg hover:bg-gray-50 hover:border-gray-400 hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3 mb-6 font-medium text-base"
              >
                {authLoading ? (
