...
const AuthButton = () => {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      setError('Google sign-in is not available yet. Please use email authentication.')
    } finally {
      setAuthLoading(false)
    }
  }
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <div className="mt-4">
              ...
              <button
                ...
                disabled={authLoading}
                className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
